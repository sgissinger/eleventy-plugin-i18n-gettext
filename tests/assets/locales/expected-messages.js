...
_n('This fruit is excellent. (shortcode)','These fruits are excellent. (shortcode)')
_n('This fruit is excellent. (function)','These fruits are excellent. (function)')
_ni('This single fruit is excellent. (function)','These ${count} fruits are   " excellent. (function)')
_ni('This single fruit is excellent. (shortcode)',"These ${count} fruits  ' are excellent. (shortcode)")
_n("This fruit is excellent. (javascript)",'These fruits are excellent. (javascript)')
_('Banana (javascript)')