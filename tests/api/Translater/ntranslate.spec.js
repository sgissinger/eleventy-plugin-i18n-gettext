...
describe('Translater.ntranslate', () => {
    ...
    it('should translate a key found in messages.po (singular)', () => {
        ...
        const actual = translater.ntranslate('fr-fr', 'Yellow banana', 'Yellow bananas', 1)
    ...
    it('should translate a key found in messages.po (plural)', () => {
        ...
        const actual = translater.ntranslate('fr-fr', 'Yellow banana', 'Yellow bananas', 2)
    ...
    it('should not translate a key not found in messages.po (singular)', () => {
        ...
        const actual = translater.ntranslate('fr-fr', 'Red blackberry', 'Red blackberries', 1)
    ...
    it('should not translate a key not found in messages.po (plural)', () => {
        ...
        const actual = translater.ntranslate('fr-fr', 'Red blackberry', 'Red blackberries', 2)
    ...
    it('should not translate a key when messages.po does not exist (singular)', () => {
        ...
        const actual = translater.ntranslate('nl-be', 'Yellow banana', 'Yellow bananas', 1)
    ...
    it('should not translate a key when messages.po does not exist (plural)', () => {
        ...
        const actual = translater.ntranslate('nl-be', 'Yellow banana', 'Yellow bananas', 2)
