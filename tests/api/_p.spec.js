...
describe('i18n._p', () => {
    ...
    it('should localize a path', () => {
        const getConfigSpy = sinon.spy(require('@11ty/eleventy/src/Config'), 'getConfig')
    ...
    it('should localize a path having a pathPrefix', () => {
        ...
        const stub = sinon.stub(require('@11ty/eleventy/src/Config'), 'getConfig').returns({ pathPrefix: '/blog/' })
